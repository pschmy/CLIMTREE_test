...
#################################################################################
#################################################################################
# script for small test dataset from the CLIMTREE metabarcoding project
# adapted from:
# Schirmer et al (2015, NAR) + Zepeda-Mendoza et al (2016) DAMe pipeline, modified by Doug Yu (2017)
#################################################################################
#################################################################################
...
# In this script, the name of the HOMEFOLDER is CLIMTREE_test/.
# Thus, run this script from inside ~/PATH_TO/CLIMTREE_test/scripts/
# The fastq files are placed in CLIMTREE_test/data/seqs/
# The DAMe supporting files are placed in CLIMTREE_test/data/
# The analysis outputs are placed in in CLIMTREE_test/analysis/
...
HOMEFOLDER="/media/schaf/46FEEB00FEEAE6E1/Users/Schafkurai/Desktop/CLIM_test"  # This is the full pathname
...
# add the folder to $PATH, so the program can be executed from anywhere
export PATH=$PATH:/home/schaf/Downloads/SPAdes-3.12.0-Linux/bin/
export PATH=$PATH:/usr/local/bin/pandaseq/
...
# test data downloaded from the BeGenDiv transfer server on 12.09.2018

# move the sequence files from the subdirectory to /data/seqs (run only once)
mv ${HOMEFOLDER}${SEQS}/2017_33/* ${HOMEFOLDER}${SEQS}
rmdir 2017_33
rm *I*fastq.gz
...
# check library integrity with md5
md5sum *.fastq.gz > fastq.gz_checksum.md5 # creates a file with all the md5 numbers of the runs
cat fastq.gz_checksum.md5 /display all the md5 with the name of the file
md5sum -c fastq.gz_checksum.md5

# alternative script by Lucas Sire to check for md5sum and compare them
#checking run 1
md5sum *fastq.gz > fastq.gz_checksums.md5 # summarize MD5 number of all the sequencing files
cat fastq.gz_checksums.md5 # display the MD5 and the run
cat 180904_2017_33_Run_1.md5 # display the original MD5 and the run given by the sequencing center
paste fastq.gz_checksums.md5 180904_2017_33_Run_1.md5 | awk '{x = $1 == $3 ? "OK" : "FALSE"; print $2" "x}' # create a file with four columns (file 2 next to file 1) and awk compare value from column 1 to 3 and assign result

#checking run 2
md5sum *fastq.gz > fastq.gz_checksums.md5 # summarize MD5 number of all the sequencing files
cat fastq.gz_checksums.md5 # display the MD5 and the run
cat 180907_2017_33_Run_2.md5 # display the original MD5 and the run given by the sequencing center
paste fastq.gz_checksums.md5 180907_2017_33_Run_2.md5 | awk '{x = $1 == $3 ? "OK" : "FALSE"; print $2" "x}' # create a file with four columns (file 2 next to file 1) and awk compare value from column 1 to 3 and assign result

#checking run 3
md5sum *fastq.gz > fastq.gz_checksums.md5 # summarize MD5 number of all the sequencing files
cat fastq.gz_checksums.md5 # display the MD5 and the run
cat 180910_2017_33_Run_3.md5 # display the original MD5 and the run given by the sequencing center
paste fastq.gz_checksums.md5 180910_2017-33-Run_3.md5 | awk '{x = $1 == $3 ? "OK" : "FALSE"; print $2" "x}' # create a file with four columns (file 2 next to file 1) and awk compare value from column 1 to 3 and assign result
########################################################################################################
########################################################################################################

#### Read in sample list and make a bash array of the sample names (e.g. A1_S1)
find * -maxdepth 0 -name "*_L001_*1_001.fastq.gz" > samplelist.txt  # find all files ending with _L001_*1_001_fastq.gz
...
echo "AdapterRemoval ver. 2.1.7" >> software_versions.txt  # cannot redirect the output of AdapterRemoval -v
...
do
              sample_prefix="$( basename $sample "_L001_*1_001.fastq.gz")"
              echo ${sample_prefix}
              # AdapterRemoval --identify-adapters --file1 ${sample_prefix}_L001_*1_001.fastq.gz --file2 ${sample_prefix}_L001_*2_001.fastq.gz
...
sickle pe -f Adaptermv_FRA_A_1.pair1.truncated -r Adaptermv_FRA_A_1.pair2.truncated -o sickle_FRA_A_1_R1.fq -p sickle_FRA_A_1_R2.fq -s sickle_Single_FRA_A_1.fq -t sanger > sickle_FRA_A_1.out
sickle pe -f Adaptermv_FRA_A_2.pair1.truncated -r Adaptermv_FRA_A_2.pair2.truncated -o sickle_FRA_A_2_R1.fq -p sickle_FRA_A_2_R2.fq -s sickle_Single_FRA_A_2.fq -t sanger > sickle_FRA_A_2.out
sickle pe -f Adaptermv_FRA_A_3.pair1.truncated -r Adaptermv_FRA_A_3.pair2.truncated -o sickle_FRA_A_3_R1.fq -p sickle_FRA_A_3_R2.fq -s sickle_Single_FRA_A_3.fq -t sanger > sickle_FRA_A_3.out

sickle pe -f Adaptermv_FRA_B_1.pair1.truncated -r Adaptermv_FRA_B_1.pair2.truncated -o sickle_FRA_B_1_R1.fq -p sickle_FRA_B_1_R2.fq -s sickle_Single_FRA_B_1.fq -t sanger > sickle_FRA_B_1.out
sickle pe -f Adaptermv_FRA_B_2.pair1.truncated -r Adaptermv_FRA_B_2.pair2.truncated -o sickle_FRA_B_2_R1.fq -p sickle_FRA_B_2_R2.fq -s sickle_Single_FRA_B_2.fq -t sanger > sickle_FRA_B_2.out
sickle pe -f Adaptermv_FRA_B_3.pair1.truncated -r Adaptermv_FRA_B_3.pair2.truncated -o sickle_FRA_B_3_R1.fq -p sickle_FRA_B_3_R2.fq -s sickle_Single_FRA_B_3.fq -t sanger > sickle_FRA_B_3.out

sickle pe -f Adaptermv_FRA_C_1.pair1.truncated -r Adaptermv_FRA_C_1.pair2.truncated -o sickle_FRA_C_1_R1.fq -p sickle_FRA_C_1_R2.fq -s sickle_Single_FRA_C_1.fq -t sanger > sickle_FRA_C_1.out
sickle pe -f Adaptermv_FRA_C_2.pair1.truncated -r Adaptermv_FRA_C_2.pair2.truncated -o sickle_FRA_C_2_R1.fq -p sickle_FRA_C_2_R2.fq -s sickle_Single_FRA_C_2.fq -t sanger > sickle_FRA_C_2.out
sickle pe -f Adaptermv_FRA_C_3.pair1.truncated -r Adaptermv_FRA_C_3.pair2.truncated -o sickle_FRA_C_3_R1.fq -p sickle_FRA_C_3_R2.fq -s sickle_Single_FRA_C_3.fq -t sanger > sickle_FRA_C_3.out

sickle pe -f Adaptermv_GER_A_1.pair1.truncated -r Adaptermv_GER_A_1.pair2.truncated -o sickle_GER_A_1_R1.fq -p sickle_GER_A_1_R2.fq -s sickle_Single_GER_A_1.fq -t sanger > sickle_GER_A_1.out
sickle pe -f Adaptermv_GER_A_2.pair1.truncated -r Adaptermv_GER_A_2.pair2.truncated -o sickle_GER_A_2_R1.fq -p sickle_GER_A_2_R2.fq -s sickle_Single_GER_A_2.fq -t sanger > sickle_GER_A_2.out
sickle pe -f Adaptermv_GER_A_3.pair1.truncated -r Adaptermv_GER_A_3.pair2.truncated -o sickle_GER_A_3_R1.fq -p sickle_GER_A_3_R2.fq -s sickle_Single_GER_A_3.fq -t sanger > sickle_GER_A_3.out

sickle pe -f Adaptermv_GER_B_1.pair1.truncated -r Adaptermv_GER_B_1.pair2.truncated -o sickle_GER_B_1_R1.fq -p sickle_GER_B_1_R2.fq -s sickle_Single_GER_B_1.fq -t sanger > sickle_GER_B_1.out
sickle pe -f Adaptermv_GER_B_2.pair1.truncated -r Adaptermv_GER_B_2.pair2.truncated -o sickle_GER_B_2_R1.fq -p sickle_GER_B_2_R2.fq -s sickle_Single_GER_B_2.fq -t sanger > sickle_GER_B_2.out
sickle pe -f Adaptermv_GER_B_3.pair1.truncated -r Adaptermv_GER_B_3.pair2.truncated -o sickle_GER_B_3_R1.fq -p sickle_GER_B_3_R2.fq -s sickle_Single_GER_B_3.fq -t sanger > sickle_GER_B_3.out

sickle pe -f Adaptermv_GER_C_1.pair1.truncated -r Adaptermv_GER_C_1.pair2.truncated -o sickle_GER_C_1_R1.fq -p sickle_GER_C_1_R2.fq -s sickle_Single_GER_C_1.fq -t sanger > sickle_GER_C_1.out
sickle pe -f Adaptermv_GER_C_2.pair1.truncated -r Adaptermv_GER_C_2.pair2.truncated -o sickle_GER_C_2_R1.fq -p sickle_GER_C_2_R2.fq -s sickle_Single_GER_C_2.fq -t sanger > sickle_GER_C_2.out
sickle pe -f Adaptermv_GER_C_3.pair1.truncated -r Adaptermv_GER_C_3.pair2.truncated -o sickle_GER_C_3_R1.fq -p sickle_GER_C_3_R2.fq -s sickle_Single_GER_C_3.fq -t sanger > sickle_GER_C_3.out
...
echo "SPAdes v3.12.0" >> software_versions.txt # SPAdes v3.12.0

# Each pair of (the reduced) fastq files requires ~20 minutes on an Intel(R) Processor 5Y10 CPU @ 0.80GHz a dual-boot Ubuntu 16.04 with 4 threads.
spades.py --only-error-correction -1 sickle_FRA_A_1_R1.fq -2 sickle_FRA_A_1_R2.fq -o SPAdes_hammer_FRA_A_1 -t 4
spades.py --only-error-correction -1 sickle_FRA_A_2_R1.fq -2 sickle_FRA_A_2_R2.fq -o SPAdes_hammer_FRA_A_2 -t 4
spades.py --only-error-correction -1 sickle_FRA_A_3_R1.fq -2 sickle_FRA_A_3_R2.fq -o SPAdes_hammer_FRA_A_3 -t 4

spades.py --only-error-correction -1 sickle_FRA_B_1_R1.fq -2 sickle_FRA_B_1_R2.fq -o SPAdes_hammer_FRA_B_1 -t 4
spades.py --only-error-correction -1 sickle_FRA_B_2_R1.fq -2 sickle_FRA_B_2_R2.fq -o SPAdes_hammer_FRA_B_2 -t 4
spades.py --only-error-correction -1 sickle_FRA_B_3_R1.fq -2 sickle_FRA_B_3_R2.fq -o SPAdes_hammer_FRA_B_3 -t 4

spades.py --only-error-correction -1 sickle_FRA_C_1_R1.fq -2 sickle_FRA_C_1_R2.fq -o SPAdes_hammer_FRA_C_1 -t 4
spades.py --only-error-correction -1 sickle_FRA_C_2_R1.fq -2 sickle_FRA_C_2_R2.fq -o SPAdes_hammer_FRA_C_2 -t 4
spades.py --only-error-correction -1 sickle_FRA_C_3_R1.fq -2 sickle_FRA_C_3_R2.fq -o SPAdes_hammer_FRA_C_3 -t 4

spades.py --only-error-correction -1 sickle_GER_A_1_R1.fq -2 sickle_GER_A_1_R2.fq -o SPAdes_hammer_GER_A_1 -t 4
spades.py --only-error-correction -1 sickle_GER_A_2_R1.fq -2 sickle_GER_A_2_R2.fq -o SPAdes_hammer_GER_A_2 -t 4
spades.py --only-error-correction -1 sickle_GER_A_3_R1.fq -2 sickle_GER_A_3_R2.fq -o SPAdes_hammer_GER_A_3 -t 4

spades.py --only-error-correction -1 sickle_GER_B_1_R1.fq -2 sickle_GER_B_1_R2.fq -o SPAdes_hammer_GER_B_1 -t 4
spades.py --only-error-correction -1 sickle_GER_B_2_R1.fq -2 sickle_GER_B_2_R2.fq -o SPAdes_hammer_GER_B_2 -t 4
spades.py --only-error-correction -1 sickle_GER_B_3_R1.fq -2 sickle_GER_B_3_R2.fq -o SPAdes_hammer_GER_B_3 -t 4

spades.py --only-error-correction -1 sickle_GER_C_1_R1.fq -2 sickle_GER_C_1_R2.fq -o SPAdes_hammer_GER_C_1 -t 4
spades.py --only-error-correction -1 sickle_GER_C_2_R1.fq -2 sickle_GER_C_2_R2.fq -o SPAdes_hammer_GER_C_2 -t 4
spades.py --only-error-correction -1 sickle_GER_C_3_R1.fq -2 sickle_GER_C_3_R2.fq -o SPAdes_hammer_GER_C_3 -t 4
...
#pandaseq -f SPAdes_hammer_FRA_A_1/corrected/sickle_FRA_A_1_R1.00.0_0.cor.fastq.gz -r SPAdes_hammer_FRA_A_1/corrected/sickle_FRA_A_1_R2.00.0_0.cor.fastq.gz -A simple_bayesian -d bfsrk -F -N -T 7 -g pandaseq_log_FRA_A_1.txt -w sickle_cor_panda_FRA_A_1.fastq


# run from within /data/seqs/

# all files are in sub-subdirectories, I don't know how to make a loop find the files in each subdirectory so instead I copy all files from within those into /data/seqs/
find . -name '*.fastq.gz' -print0 | xargs -0 cp -t ~/Desktop/CLIMTREE_test/data/seqs

# my first loop!
for file1 in sickle*R1*fastq.gz #iterates over all files containing R1 in their name and an fastq.gz type
do
file2=${file1/R1/R2} #gets the second file by replacing R1 by R2
out1=${file1%%R1.00.0_0.cor.fastq.gz}cor_panda.fastq #%% removes suffix, output for the fastq file
out2=${file1%%R1.00.0_0.cor.fastq.gz}pandaseq_log.txt #%% removes suffix, output for the log.txt file
pandaseq -f $file1 -r $file2 -A simple_bayesian -d bfsrk -F -N -T 7 -g $out2 -w $out1 #can I redirect the output to another folder directly somehow?

done
## it's taking the wrong fastq.gz files, need to tell it to look into the folders -> fixed by copying all necessary files into /data/seqs/, not very pretty
...
# tiny loop for gzipping all the pandaseq output
for file1 in *fastq
do
gzip $file1
done
...
rm *log.txt
# remove files copied from SPAdes folders
rm sickle*cor.fastq.gz
# since we're at it remove leftover files from
rm *001.fastq.gz

ls -lrtFh # list the files

# The sickle_FRA/GER_{A, B, C}_{1, 2, 3}_cor_panda are our final fastq files.
# They have been adapter-trimmed, quality-trimmed, denoised, and merged.
# 18 pairs of fastq files (forward and reverse reads) have been reduced to 18 fastq files (merged reads).
...
mkdir dame_pipe/ # make a folder for the for the continued pipeline containing subfolders for the different PCR replicates
mkdir dame_pipe/pool1/
mkdir dame_pipe/pool2/
mkdir dame_pipe/pool3/

mv *1*.fastq.gz dame_pipe/pool1/
mv *2*.fastq.gz dame_pipe/pool2/
mv *3*.fastq.gz dame_pipe/pool3/

ls -lrtFh dame_pipe/pool1
...
echo "https://github.com/shyamsg/DAMe.git Downloaded on 19 September 2018" >> ${HOMEFOLDER}data/seqs/software_versions.txt

# provide one text file with the primers and one with all tags used in the PCR in /CLIMTREE_test/data/
cp ~/Desktop/300TestTeaching-trial/data/Primers_COILeray.txt ${HOMEFOLDER}data

cd ${HOMEFOLDER}data/seqs/dame_pipe/pool1/
...
cd ${HOMEFOLDER}data/seqs/dame_pipe/pool2/
...
cd ${HOMEFOLDER}data/seqs/dame_pipe/pool3/
...
cd ${HOMEFOLDER}data/seqs/dame_pipe
...
# then move heatmaps from inside the pool folders into dame_pipe/
cd ${HOMEFOLDER}data/seqs/dame_pipe/
...
# Run filter.py inside dame_pipe/
cd ${HOMEFOLDER}data/seqs/dame_pipe/
...
cd ${HOMEFOLDER}data/seqs/dame_pipe/Filter_min${MINPCR_1}PCRs_min${MINREADS_1}copies_B/
...
head ${HOMEFOLDER}data/seqs/dame_pipe/Filter_min${MINPCR}PCRs_min${MINREADS}copies_B/FilteredReads.fna

# re-run plotLengthFreqMetrics_perSample.py
cd ${HOMEFOLDER}data/seqs/dame_pipe/Filter_min${MINPCR}PCRs_min${MINREADS}copies_B
python ${DAME}plotLengthFreqMetrics_perSample.py -f FilteredReads.fna -p ${HOMEFOLDER}data/PSinfo_300test_COIB.txt -n 3
...
mv ${HOMEFOLDER}${SEQS}dame_pipe/Filter_min${MINPCR}PCRs_min${MINREADS}copies_B ${HOMEFOLDER}${ANALYSIS}OTU_transient_results/Filter_min${MINPCR}PCRs_min${MINREADS}copies_B
...
####################################################################################################
# Record for installation under Ubuntu 16.04 on this machine
####################################################################################################
...
sudo apt-get install build-essential libtool automake zlib1g-dev libbz2-dev libltdl-dev pkg-config
sudo cp -r pandaseq /usr/local/bin/

# very lengthy installation, pandaseq was not properly installed, sudo ldconfig fixed it
...
sudo mv ~/Desktop/DAMe /usr/local/bin



####################################################################################################
# Record of how I installed the software. Don't run this -- Doug Yu
####################################################################################################
